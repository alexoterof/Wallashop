package com.alexotero.wallashop.controladores;
...
//					.fromMethodName(FilesController.class, "serveFile", imagen).build().toUriString());
			String imagen = fileService.upload(file);
			usuario.setAvatar(imagen);
			
	}else usuario.setAvatar("https://eu.ui-avatars.com/api/?name=" + usuario.getNombre() + "+" + usuario.getApellidos());
